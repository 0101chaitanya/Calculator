...
function keyValidation(e) {
    ...
    } else if (e.code === 'Period' || e.target.id === '.') {
        input.textContent += '.';

    } else if (e.code === 'Enter' || e.target.id === '=') {

        obj.input = input.textContent;
...
let obj = Object.create(Object.prototype, { execute: function() {} });

input.textContent = '2+3';
