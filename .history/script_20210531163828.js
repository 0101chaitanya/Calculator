...
function division(obj) {
    if (obj.parsedDiv != []) {
        ...
        obj.parsedDiv.forEach(function(i) {
            let divIndex = 0;
            console.log(divAdjuster, divIndex);
            obj.divStack[divAdjuster] = parseFloat(obj.numArray[(i)]) / parseFloat(obj.numArray[(i + 1)]);
            ...
            obj.parsedMul.forEach(function(value) {
                {
                    if (value >= i) {
                        // console.log(i, value);
                        value = value - divIndex - divAdjuster;
                        //      console.log(value);
