...
function inputFunction(inputVar) {
    if (Number(inputVar) == inputVar) {
        if (operatorValue == 0) {
            input.textContent = parseFloat(parseFloat((input.textContent + inputVar)).toFixed(4));
        } else if (operatorValue == 1) {
            input.textContent = parseFloat(parseFloat((parseFloat(input.textContent) + inputVar)).toFixed(4));
