...
obj.parsedDiv.forEach(function(item) {
    obj.divStack[divIndex] = parseFloat(obj.numArray[(item)]) / parseFloat(obj.numArray[(item + 1)]);
...
obj.parsedSub.forEach(function(item) {
    obj.subStack[subIndex] = parseFloat(obj.numArray[(item)]) - parseFloat(obj.numArray[(item + 1)]);
