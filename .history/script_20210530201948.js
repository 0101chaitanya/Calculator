...
obj.numArray = obj.subFun.split(/\D/g);
let regX = /\D/g;
...
obj.parsedDiv.forEach(function(item) {
    divStack += Number(obj.numArray[Number[item] - 1]) + Number(obj.numArray[Number[item] + 1]);
});
console.log(Number(obj.numArray[Number[obj.parsedDiv[0]] - 1]));
