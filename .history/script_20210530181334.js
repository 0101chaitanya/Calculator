...
obj.divFun = obj.str.slice().replace('/', `div()`);
console.log(obj.divFun);
obj.mulFun = obj.divFun.slice().replace('*', `mul()`);
console.log(obj.mulFun);
obj.addFun = obj.mulFun.slice().replace('+', `add()`);
console.log(obj.addFun);
obj.subFun = obj.addFun.slice().replace('-', `sub()`);
console.log(obj.subFun);
let ob.arr = obj.subFun.split(/\D/g);
let regX;
